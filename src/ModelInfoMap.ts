...
> = {
  ...
  [ModelEnum['gpt-4.1']]: {
    ...
    supportsImageInput: true,
    legacy: true,
    legacyReason: 'Superceded by GPT-5.2',
  ...
  [ModelEnum['gpt-5.2']]: {
    ...
    contextWindowTokenLimit: 400000,
    outputTokenLimit: 128000,
    pricePerMillionInputTokens: 1.75,
    pricePerMillionOutputTokens: 14,
    tokenizerId: 'Xenova/gpt-4o',
    notes:
      'Most advanced frontier model for professional work and long-running agents. Knowledge cutoff: Aug 31, 2025.',
    supportsImageInput: true,
  ...
  [ModelEnum['gpt-5.2-pro']]: {
    name: 'GPT-5.2 Pro',
    provider: AI_PROVIDERS.OPENAI,
    contextWindowTokenLimit: 400000,
    outputTokenLimit: 128000,
    pricePerMillionInputTokens: 21,
    pricePerMillionOutputTokens: 168,
    tokenizerId: 'Xenova/gpt-4o',
    notes:
      'Smartest and most trustworthy option for highest accuracy. Knowledge cutoff: Aug 31, 2025.',
    supportsImageInput: true,
    recommendedForCoding: false,
    recommendedForWriting: false,
    reasoning: true,
  ...
  [ModelEnum['claude-3-5-haiku-20241022']]: {
    ...
    small: true,
    legacy: true,
    legacyReason: 'Superceded by Claude Haiku 4.5',
  },
  ...
  [ModelEnum['claude-sonnet-4-20250514']]: {
    ...
    recommendedForWriting: false,
    legacy: true,
    legacyReason: 'Superceded by Claude Sonnet 4.5',
  ...
  [ModelEnum['claude-sonnet-4-5-20250929']]: {
    ...
    pricePerMillionOutputTokens: 15,
    tokenizerId: 'Xenova/claude-tokenizer',
    notes: 'Smart model for complex agents and coding',
    notesUrl: 'https://www.anthropic.com/claude/sonnet',
    supportsImageInput: true,
    recommendedForCoding: true,
    recommendedForWriting: true,
  ...
  [ModelEnum['claude-haiku-4-5-20251001']]: {
    ...
    notesUrl: 'https://www.anthropic.com/claude/haiku',
    supportsImageInput: true,
    small: true,
    legacy: false,
  ...
  [ModelEnum['gemini-2.5-pro']]: {
    ...
    supportsImageInput: true,
    legacy: true,
    legacyReason: 'Superceded by Gemini 3 Pro',
  ...
  [ModelEnum['gemini-3-pro-preview']]: {
    ...
    tokenizerId: 'Xenova/gpt-4o',
    notes:
      'Most powerful model for multimodal understanding, agentic workflows, and coding. Pricing doubles for prompts >200k tokens.',
    notesUrl: 'https://ai.google.dev/gemini-api/docs/gemini-3',
    reasoning: true,
    recommendedForCoding: true,
    recommendedForWriting: true,
    supportsImageInput: true,
